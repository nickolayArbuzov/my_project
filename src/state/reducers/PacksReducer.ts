...
export type ActionType = GetPacks | AddPack | 
                        DeletePack | UpdatePack | 
                        FetchPacks | FetchPacksError

export type FetchPacks = ReturnType<typeof fetchPacksAC>
export type FetchPacksError = ReturnType<typeof fetchPacksErrorAC>
